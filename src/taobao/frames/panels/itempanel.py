...
class BasicPanel(wx.Panel):
    def __init__(self, parent,id=-1):
        ...
        self.order_label6  = wx.StaticText(self,-1,u'商品数量')
        ...
        self.order_label10  = wx.StaticText(self,-1,u'让利金额')
        self.order_content10  = wx.TextCtrl(self,-1)
        self.buyer_cod_label = wx.StaticText(self,-1,u'买家货到付款服务费')
    ...
    def setData(self,trade): 
        ...
        self.order_content2.SetValue(TRADE_TYPE.get(trade.type,u'其他'))
        ...
        self.order_content11.SetValue(SHIPPING_TYPE.get(trade.shipping_type,u'其他'))
...
class DetailPanel(wx.Panel):
    ...
    def __init__(self,parent,id=-1):
        ...
        colLabels = (u'商品图片',u'订单ID',u'商品外部编码',u'商品简称',u'规格编码',u'规格属性',u'订购数量',u'实际单价',u'实付金额',
                     u'退款单号',u'退款状态',u'订单类型',u'订单状态',u'系统状态')
